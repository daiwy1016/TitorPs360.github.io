...
return [
    ...
    'admin.layout.dashboard'                    => '控制面板',
    'admin.layout.manage-manga'                 => "$mangaSingular",
    'admin.layout.manga-list'                   => $manga_Name."列表",
    'admin.layout.hotmanga'                     => $manga_Name."排行榜",
    ...
    'admin.manga.detail.other-names'       	=> '别名:',
    'admin.manga.detail.author'            	=> '作者(s):',
    'admin.manga.detail.released'          	=> '更新时间:',
    'admin.manga.detail.categories'        	=> '类别:',
    'admin.manga.detail.summary'           	=> '简介:',
    ...
    'front.home.logout'                         => '退出',
    'front.home.yesterday'                      => '昨日',
    'front.home.today'                          => '今日',
    ...
    'front.manga.status'            		=> "状态",
    'front.manga.other-names'       		=> '别名',
    'front.manga.author'            		=> '作者(s)',
    'front.manga.released'          		=> '更新时间',
    'front.manga.categories'        		=> '类别',
    'front.manga.summary'           		=> '简介',
    'front.manga.rating'                	=> '漫画评分',
    'front.manga.chapters'             		=> ':manganame 章节目录',
    'front.manga.chapters-tip'              => '敬告：尊敬的漫画原作者，如果您不想让《:manganame》出现在本站，请您立即联系我们删除。为此给您带来的不便，敬请谅解！我们始终如一的支持维护著作版权，也愿意为优秀漫画的宣传推广做出应有的贡献！欢迎各方洽谈合作！',
    'front.manga.chapters-tip2'             => ' 敬告：《:manganame》漫画仅供试看，若喜欢，请支持购买正版。如作者不希望该漫画出现在本站，请联系我们删除。',
    ...
    'front.manga.download'            		=> '下载',

    /** Reader **/
    'front.reader.manga'                         => '漫画',
    'front.reader.page'                         => '页',
    'front.reader.chaptre'                      => '章节',
    'front.reader.prev'                         => '上一页',
    'front.reader.next'                         => '下一页',
    'front.reader.tips'                         => '提示:',
    'front.reader.tips-message'                 => '鼠标单击图片或按左右方向键←→翻页! ',
    'front.reader.first-page-message'           => '已经是第一页.',
    'front.reader.last-page-message'            => '这是最后一页！',
    'front.reader.no-page'                      => 'no page published yet !!!',
    'front.reader.other-chapter'                => '其他章节',
    'front.reader.reading-mode'                 => '阅读方式',
    'front.reader.page-per-page'                => '分页阅读',
    'front.reader.all-pages'                    => '下拉阅读',
    ...
    'front.bookmarks.bookmark-at'               => '收藏时间',
    'front.bookmarks.bookmark'                  => '收藏',
    'front.bookmarks.bookmarked'                => '已收藏',

    /***** v1.7 *****/
    /** Admin **/
    'admin.manga.create.artist'                 => '漫画作者(s)',
    ...
    'admin.comictype.edit'                      => '编辑',
    'admin.comictype.delete'                    => '删除',
    ...
    'front.reader.prevChap'                     => '上一章',
    'front.reader.nextChap'                     => '下一章',
